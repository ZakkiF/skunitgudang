...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'stokkeepingunitgudang_384c68aa04fe47647939_20230515015527_archive.daf';
        const ARCHIVE_SIZE       = '104592318';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '384c68a-15015527';
        const SECONDARY_PACKAGE_HASH = '369bf76-15015527';
        const VERSION            = '1.5.4';
